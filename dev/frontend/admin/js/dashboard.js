export function renderDashboard(state, ui) {
  ...
  const fulfillmentLabels = { pending_pickup: "待自提", ready: "已到站待提货", received: "已到站待提货", pending_ship: "待配送", shipping: "配送中", delivered: "已送达", picked_up: "已提货", delivery_exception: "配送异常" };
