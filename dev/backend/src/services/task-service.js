...
async function submitTask(state, user, taskId, payload) {
  ...
  const submission = {
    ...
    taskSnapshot: {
      ...
      platformFinancials: task.platformFinancials,
      reward: task.reward,
      usersRatio: task.usersRatio,
      bili: task.bili,
      biliReward: task.biliReward,
      biliSyReward: task.biliSyReward,
      invitationRatio: task.invitationRatio,
      inviteCommissionPoints: task.inviteCommissionPoints,
      agencyRatio: task.agencyRatio,
      commissionReward: task.commissionReward,
      commissionSyReward: task.commissionSyReward,
