...
function createSeed() {
  return {
    config: {
      ...
      monthlyPointRewardEnabled: true,
      monthlyPointRewardSettlementHour: 0,
      monthlyPointRewardSettlementMinute: 10,
      monthlyPointRewardRules: [
